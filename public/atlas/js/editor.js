...
<div style="display:flex;align-items:center;gap:14px;margin-bottom:10px">
  <img src="/atlas/img/system/rpgatlas-logo.svg" alt="" width="56" height="56">
  <div>
...
` }),
  ...
  act("play", { label: "Playtest", icon: "play", tip: "Save and run the game", run() {
    saveNow();
    window.open("/play", "rpgatlas_play");
  } });
  ...
  async function bootEditor() {
    if (window.__RPGATLAS_EDITOR_BOOTED__) return;
    window.__RPGATLAS_EDITOR_BOOTED__ = true;
